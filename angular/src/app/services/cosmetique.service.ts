...
export class CosmetiqueService {
  ...
  apiURLRay: string = 'http://localhost:9191/cosmetiques-service/cosmetiques/ray';
  apiURL: string = 'http://localhost:9191/cosmetiques-service/cosmetiques/api';
  apiUrl1: string = 'http://localhost:9191/cosmetiques-service//cosmetiques/api/image/uplaodImageCosm';
